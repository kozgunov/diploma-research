...
def load_and_prepare_glue():  # load the SuperGLUE dataset - 1st benchmark
...
def load_and_prepare_superglue():  # load the SuperGLUE dataset - 2nd benchmark

    superglue_dataset = load_dataset('super_glue', 'boolq')
